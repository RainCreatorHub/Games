...
local function toggle()
    ...
    if ativo then
        ...
        task.spawn(function()
            while ativo and plataforma.Parent do
                plataforma.CFrame = CFrame.new(h.Position - Vector3.new(0, 3, 0))
                plataforma.CFrame = plataforma.CFrame + Vector3.new(0, v * task.wait(), 0)
            end
        end)
    else
        sw.BackgroundColor3 = Color3.fromRGB(70, 70, 70)
